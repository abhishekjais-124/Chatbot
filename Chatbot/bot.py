...
convo1 = []
f = open("C:/Users/ABHISHEK JAISWAL/Documents/Hackathon/conver.txt")
for lines in f:
    lines.strip()
...
#print(convo)
convo2 = []
f = open("C:/Users/ABHISHEK JAISWAL/Documents/Hackathon/conver2.txt")
for lines in f:
    lines.strip()
...
root.iconbitmap('C:/Users/ABHISHEK JAISWAL/Documents/Hackathon/abcd.ico')
root.title('MedGuru')
my_img =ImageTk.PhotoImage(Image.open("C:/Users/ABHISHEK JAISWAL/Documents/Hackathon/MG4.jpg"))
